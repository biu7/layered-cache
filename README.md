...
- **Smart Key Building**: Automatically handles different ID types (string, int, int32, int64, etc.) to generate formatted cache keys
...
Thanks to [@mgtv-tech/jetcache-go](https://github.com/mgtv-tech/jetcache-go) for providing design inspiration and reference implementation
